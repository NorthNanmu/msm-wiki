...
::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`f98ccd9`](https://github.com/msm9527/msm/commit/f98ccd9b0ae9b132355b516377ebcaa2bc5691b8)
- **提交信息**: 增强LXC激活参数异常自愈重试逻辑
- **提交作者**: msm
- **提交时间**: 2026-02-09 00:42:23 +0800
:::
