...
::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`13f4e85`](https://github.com/msm9527/msm/commit/13f4e85446c2d21ee81461532ab29803a869f8d0)
- **提交信息**: 增强激活失败自愈并改进授权错误日志
- **提交作者**: msm
- **提交时间**: 2026-02-09 00:28:58 +0800
:::
