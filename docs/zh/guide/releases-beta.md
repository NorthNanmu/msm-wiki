...
> 当前 Beta 版本：`beta-0.9.4`  
> 发布时间：2026-02-08 13:25  
> - 发布页：<https://github.com/msm9527/msm-wiki/releases/tag/beta-0.9.4>  
...
::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`1aa45fa`](https://github.com/msm9527/msm/commit/1aa45fac2de984f1ea194f0807abad891fb2910d)
- **提交信息**: chore: sync version to 0.9.4
- **提交作者**: github-actions[bot]
- **提交时间**: 2026-02-08 05:25:26 +0000
:::
