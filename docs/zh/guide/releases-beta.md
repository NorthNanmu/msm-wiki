...
::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`5fb52c3`](https://github.com/msm9527/msm/commit/5fb52c35c061619d8be9de9f2637ac7909366600)
- **提交信息**: fix: 修复 nftables 区间边界并增强网络配置步骤日志
- **提交作者**: msm
- **提交时间**: 2026-02-08 22:22:30 +0800
:::
