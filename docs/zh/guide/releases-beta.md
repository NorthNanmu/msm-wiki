...
::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`363b1ed`](https://github.com/msm9527/msm/commit/363b1ed8b51e45ffe9793687525d2dd2589011a5)
- **提交信息**: 修复授权机器码缺失导致激活失败
- **提交作者**: msm
- **提交时间**: 2026-02-08 23:37:22 +0800
:::
